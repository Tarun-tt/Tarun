...
export default {
  ...
  "definition": "Folder Structure is a fundamental concept in TanStack Query that every developer should master.",
  ...
  "examples": [
    ...
    {
      "title": "Best Practice",
      "code": "// Folder Structure - Example 5\nconst NAMESPACE = \"tanstack/folder-structure\";\nconsole.log(NAMESPACE);",
      "output": "tanstack/folder-structure",
